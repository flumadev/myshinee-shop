...
function Index() {
  ...
  const treatExpireTime = () => {
    const hour = new Date(
      paymentData.charges[0].last_transaction.expires_at
    ).getHours();
    let minutes = new Date(paymentData.charges[0].last_transaction.expires_at)
      .getMinutes()
      .toString();
  ...
  return (
    <Container w="100%" maxW={'7xl'} py={'20'} textAlign="center">
      ...
      <Text textAlign="center">
        Falta pouco pra completar o seu pedido! Use os dados abaixo para pagar:
      </Text>
      <Container
        mt={'20px'}
      ...
      >
        ...
        <Text mb="20px">
          Use o app de seu banco ou carteira digital para escanear o código QR
          abaixo:
        </Text>
        <Skeleton
          width="240px"
          height={'240px'}
          margin="0 auto"
          isLoaded={paymentData.charges !== undefined}
        >
          <Image
            src={
              paymentData.charges &&
              paymentData.charges[0].last_transaction.qr_code_url
            }
            width="240px"
            height={'240px'}
            alt="qrcode"
